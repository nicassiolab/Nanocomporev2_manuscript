#!/bin/bash
#PBS -l select=1:ncpus=28:mem=64gb:scratch=200gb
#PBS -l walltime=100:00:00
#PBS -j oe
#PBS -N WT_SPK_uncalled4
#PBS -q workq
...
uncalled4 align --ref $transcriptome_fasta --reads $pod5 --bam-in $aligned_bam --bam-out $output --kit SQK-RNA004 --flowcell FLO-PRO004RA -p 32
