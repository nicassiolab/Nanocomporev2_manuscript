#!/bin/bash
#PBS -l select=1:ncpus=32:mem=400gb:ngpus=0:scratch=550gb:nodetype=cpu_hugemem
#PBS -l walltime=100:00:00
#PBS -j oe
#PBS -N f5c_collapse_WT_1_rna004
#PBS -q workq
...
/home/mzdravkov/f5c-v1.5/f5c_x86_64_linux eventalign --reads $fasta \
						     ...
						     -x desktop-mid \
						     -K 1024 \
	| uv run python /home/mzdravkov/nanocompore/nanocompore/__main__.py eventalign_collapse --ref $ref -o $output --nthreads 32 --tmp $PBS_SCRATCHDIR
