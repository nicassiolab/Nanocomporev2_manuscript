#!/bin/bash
#PBS -l select=1:ncpus=14:mem=90gb:ngpus=0:scratch=550gb
#PBS -l walltime=100:00:00
#PBS -j oe
#PBS -N f5c_collapse_STORM_SPK_rna004
#PBS -q workq
...
/home/mzdravkov/f5c-v1.5/f5c_x86_64_linux eventalign --reads $fasta \
						     ...
						     -x desktop-mid \
						     -K 1024 \
	| uv run python /home/mzdravkov/nanocompore/nanocompore/__main__.py eventalign_collapse --ref $ref -o $tmp_output --nthreads 14 --tmp $PBS_SCRATCHDIR
